...
for element in data.get("body", []):
    ...
    sqs.send_message(QueueUrl=sqs_url,MessageBody=f"symbol:{stock_symbol},
                                                    identifier:{stock_identifier},
                                                    open:{stock_open_price},
                                                    dayHigh:{stock_dayhigh_price},
                                                    dayLow:{stock_daylow_price},
                                                    lastPrice:{stock_last_price},
                                                    previousClose:{stock_prev_close_price},
                                                    change:{stock_change_price},
                                                    yearHigh:{stock_yearhigh_price},
                                                    yearLow:{stock_yearlow_price}")
